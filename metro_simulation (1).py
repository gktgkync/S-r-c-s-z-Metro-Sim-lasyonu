...
class MetroAgi:
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
     ...
     pq = [(0, id(baslangic), baslangic, [baslangic])]  # `id(baslangic)` eklendi
     ziyaret_edilen = {}
    
     while pq:
        toplam_sure, _, mevcut, yol = heapq.heappop(pq)  # `_` ile id değeri göz ardı edildi
        ...
        for komsu, sure in mevcut.komsular:
            ...
            heapq.heappush(pq, (yeni_sure, id(komsu), komsu, yol + [komsu]))  # `id(komsu)` eklendi
